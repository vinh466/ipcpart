<template>
  <div class="staff-popup-view" @click="(e) => e.stopPropagation()">
    <div class="heading">
    ...
    <hr />
    <form class="staff-form" @submit="handleFormSubmit">
...
<script setup lang="ts">
  ...
  const handleFormSubmit = handleSubmit(async (values) => {
    ...
    try {
      const success = await adminUserService.updateUser(values);
      if (success) {
