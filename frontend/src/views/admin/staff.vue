<template>
  <div class="staff-datatable" v-if="!unauthorized">
    <div class="function-button" @click="handleAddUser">
      <button class="add"><font-awesome-icon icon="fa-solid fa-plus" /></button>
...
<script setup lang="ts">
  ...
  import StaffAddPopup from './component/StaffAddPopup.vue';
  import StaffEditPopup from './component/StaffEditPopup.vue';
  ...
  async function handleDelete(username: string) {
    try {
      const OK = await adminUserService.remove(username);
      if (OK) {
  ...
  async function getStaff() {
    ...
    try {
      userData.value = await adminStaffService.getStaff({
